...
export class ThemeConfigurationTemplate extends Component {
        ...
        if (!$('.backmate_theme_layout').length){
            ...
            jsonrpc('/get_theme_style',{}).then(function (data) {
                ...
                if (is_navbar_style == 'collapsed') {
                    $('#navbar_style_collapsed').attr('checked', true);
                }
                else{
                    $('#navbar_style_expanded').attr('checked', true);
                }
   ...
   async onWillStart() {
        ...
        this.is_group_theme_configuration_user = await this.user.hasGroup("sh_backmate_theme_adv_enterprise.group_theme_configuration");
    }
...
registry.category("systray").add("sh_backmate_theme_adv_enterprise.ThemeConfigurationTemplate", { Component: ThemeConfigurationTemplate });
