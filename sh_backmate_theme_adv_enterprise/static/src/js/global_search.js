...
export class GlobalSearchSh extends Component {
    static template = "sh_backmate_theme_adv_enterprise.GlobalSearch";
    ...
    setup() {
        ...
        onMounted(() => {
            ...
            if (isMobileOS()){
                $("#topbar_search_icon").css("display", "block");
                $(".usermenu_search_input2").css("display", "none");
                $("#topbar_full_search_icon").css("display", "none");
            }
        });
    }
                    ...
                    if (data) {
                        ...
                        if (results.length > 0) {
                            ...
                            const sh_search_results_html = renderToFragment(
                                    'sh_backmate_theme_adv_enterprise.MenuSearchResults', {
                                    results : results,
                                    widget: self,
                                });
...
registry.category("systray").add("sh_backmate_theme_adv_enterprise.GlobalSearch", { Component: GlobalSearchSh }, { sequence: 25 });