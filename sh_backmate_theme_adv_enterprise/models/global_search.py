...
class GlobalSearchFields(models.Model):
    ...
    def sh_o2m_dynamic_action_action(self):
        if self.ttype == 'one2many':
            view = self.env.ref('sh_backmate_theme_adv_enterprise.sh_o2m_global_search_form')
            return {
            ...
            view = self.env.ref('sh_backmate_theme_adv_enterprise.sh_m2o_global_search_form')
            return {
